...
def build_args():
    ...
    parser.add_argument('--pl_method', type=str,default='Topk3_distance', choices=['temperature_scalling','Topk3_distance','Top2k_distance', 'glc'])
    ...
    parser.add_argument('--V_times', type=float, default= 1.4)
