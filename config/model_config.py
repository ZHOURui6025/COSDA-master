...
def build_args():
    ...
    parser.add_argument('--lambda_exo', type=float, default=0.5, help='hyperparameter for loss-exo weight (default: 1)')
    ...
    parser.add_argument('--pl_method', type=str,default='VMP', choices=['temperature_scalling','VMP'])
    ...
    parser.add_argument('--V_times', type=float, default=0.5, help='train without cl')
    ...
    args.note = 'seed'+str(args.seed)+'_epo'+str(args.epochs)+'_bs'+str(args.batch_size)+'_Ktimes'+str(args.K_times)+\
                '_exo'+str(args.lambda_exo)+ '_V'+str(args.V_times)+'_pl'+args.pl_method+'_kl'+str(args.lambda_kl)+'_itv'+str(args.log_interval)+\
                '_lr'+str(args.lr)+'_da'+args.da_method+'_dt'+str(args.lambda_beta_d)+'_bn'+str(args.bn_type)+'_warm'+str(args.warm_up_epoch)+'_es'+\
                str(args.lambda_beta_e)+'_th'+str(args.confidence_th)+'_label'+str(args.if_true_label)+'_atype'+str(args.adaptation_type)
    print(args.note)
    ...
    if args.dataset == "Office":
        ...
        args.source_data_dir = "../dataset/VisDA/train/"
        args.target_data_dir = "../dataset/VisDA/validation/"
        args.sourcelist_data_dir = "./data/VisDA/train/"
        args.targetlist_data_dir = "./data/VisDA/validation/"
        ...
        if args.target_label_type == "OSDA":
            ...
            raise NotImplementedError("Unknown target label type")
